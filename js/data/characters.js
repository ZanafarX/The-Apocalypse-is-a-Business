...
var CHARACTERS = [
...

  {
    ...
    summary: 'Lead of the Exploit Lab. Competitive speedrunner from age sixteen, initially in games with large communities and later in games with communities of eighteen people and declining servers. Two of her pre-integration exploit discoveries required emergency developer patches within forty-eight hours, both because she ran them on public servers rather than reporting them. Both times she considered this a success.<br><br>She is enthusiastic about the apocalypse. The world broke, the rules became legible, and her entire skill set became professionally relevant; she considers this objectively good news and is aware that most people in the building do not share the assessment.<br><br>She has tested things on herself that she should have tested on systems. She will continue to do this.',
    coreFlaw: 'Tactically reckless by any reasonable standard. The analyst most likely to create problems through enthusiasm rather than resentment.',
    skills: [
      {
        name: 'NULL STATE',
        type: 'Passive',
...

  {
    ...
    appearance: 'Age 24. Brown hair worn up in a high bun on working days and falling loose when she is off the clock. Blue-gray eyes. Practical V-neck top.',
    summary: 'Scribe of the System Analysis Division and the formal-records infrastructure underwriting Matteo\'s contract architecture. Pre-integration, she was completing a part-time legal administration certificate while working at a notarial office in the Quadrilatero, processing property records and witnessing documents. She started at nineteen. By the time the System arrived she was fast, precise, and held a thorough understanding of what formal documentation does and does not protect.<br><br>She married Ermilio at twenty, which both their families considered premature and neither of them reconsidered. She was the one who decided they were going with Cecilia.',
    coreFlaw: 'The only member of the Division who came to the Palazzo entirely because of someone else\'s value to the organization. She has a clear view of what this means for her leverage, and a slightly less clear view of what it means for her relationship with an organization she joined under duress and now functionally supports.',
    skills: [
      {
        name: 'INSCRIPTION',
        type: 'Active',
