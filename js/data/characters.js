...
var CHARACTERS = [
...

  {
    ...
    coreFlaw: 'Indispensable, outmaneuvered, and boxed in, and aware of all three. The acquisition was coercion dressed as mutual interest, and what stings isn\'t mistreatment; it\'s that the man who reads systems for a living was read first, modeled and routed before he understood a game was underway. He\'s the type to reach for leverage through control of information rather than open confrontation, and he hasn\'t decided what he\'d do with that leverage if he got it. The deeper problem he can already see: the System is reshaping how he thinks, not just sharpening it, and the only tool he\'d use to study the change is the thing being changed.',
    skills: [
      {
        name: 'LOAD-BEARING',
